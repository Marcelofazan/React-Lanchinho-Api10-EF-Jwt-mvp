...
Aplicativo de Lanchinho Arquitetura Vertical Slice com automação Cloud Google Sheets em React 18 e API com autenticação Jwt em C# ASP.NET Core 10 EF com banco de dados SQL-Server.
